<div class='bg-black h-16 border-b-2 border-white w-full shadow-3xl flex justify-center'>
    <div class="flex items-center justify-center lg:justify-between w-full max-w-7xl">
        <button data-collapse-toggle="navbar-default" type="button"
            class="absolute w-10 h-10 left-3 text-sm text-white rounded-lg lg:hidden" aria-controls="navbar-default"
            aria-expanded="false">
        ...
        <nav class='lg:hidden hidden' id="navbar-default">
            <ul
                class="text-white font-poppins border-r-2 border-b-2  uppercase border-white items-center absolute top-16 left-0 bg-black">
                ...
                <li class="py-4 h-16 w-48 text-center"><a href="/gallery">Gallery</a></li>
            </ul>
        </nav>
        ...
        <nav>
            <ul class="text-white font-poppins lg:flex hidden uppercase border-white items-center">
                ...
                <li class="pt-5 py-4 border-r-2 h-16 w-48 text-center"><a href="/gallery">Gallery</a></li>
