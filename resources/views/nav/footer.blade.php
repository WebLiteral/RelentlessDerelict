<div class='bg-dark border-t-2 border-light w-full shadow-3xl font-bebas flex justify-center'>
    <div
        ...
        <div class="md:text-left">
            ...
            <p class="font-poppins italic text-sm">Business enquiries only.</p>
        </div>
        <div class="md:text-right">

            <p class="text-3xl py-6 md:py-0">&copy; 2024 LITERALHAT</p>
            <p class="font-poppins text-sm hidden lg:block">All rights reserved</p>
        </div>
    </div>
